...
var DataStorage = function (_React$Component) {
  _inherits(DataStorage, _React$Component);

  function DataStorage(props) {
    _classCallCheck(this, DataStorage);

    var _this = _possibleConstructorReturn(this, (DataStorage.__proto__ || Object.getPrototypeOf(DataStorage)).call(this, props));

    _this.DATA_KEY = 'george_recipes';
    return _this;
  } // end of constructor
  ...
  _createClass(DataStorage, [{
    ...
    key: 'saveData',
    value: function saveData(element) {
    ...
    value: function readData() {
      var data = localStorage.getItem(this.DATA_KEY);
      return data && data.length ? JSON.parse(data) : this.initialData();
    }
  }, {
    key: 'resetData',
    value: function resetData() {
      var recipes = this.initialData();
  ...
  return DataStorage;
}(React.Component); // end of DataStorage

var ModalWrapper = function ModalWrapper(props) {

  var hanldeBackgroundClick = function hanldeBackgroundClick(e) {
  ...
  var okButton = props.showOk ? React.createElement(
    'button',
    { onClick: onOk, disabled: props.okDisabled },
    props.okText
  ) : null;
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { onClick: hanldeBackgroundClick, className: content },
      React.createElement(
        'header',
        null,
        React.createElement(
...
ModalWrapper.prototypes = {
  ...
  children: PropTypes.oneOfType([PropTypes.array, PropTypes.element, PropTypes.sting]).isRequired,
